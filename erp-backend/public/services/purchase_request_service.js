...
const purchase_request_1 = __importDefault(require("../models/purchase_request"));
const createPurchaseRequest = (req, res, next) => {
    const { requestBy, totaBill, status } = req.body;
    const PurchaseRequest = new purchase_request_1.default({
...
const updatePurchaseRequest = (req, res, next) => {
    ...
    return purchase_request_1.default.findById(id).then((order) => {
        if (order) {
...
const getPurchaseRequests = (req, res, next) => {
    ...
    return purchase_request_1.default
...
const deletePurchaseRequest = (req, res, next) => {
    const id = req.params.id;
    return purchase_request_1.default.findByIdAndDelete(id)
